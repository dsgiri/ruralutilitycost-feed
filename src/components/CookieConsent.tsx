  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-slate-900 text-white p-4 md:p-6 z-50 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl">
      ...
      <div className="flex shrink-0 gap-3">
        <a href="/legal" className="px-4 py-2 text-[14px] font-semibold text-line hover:text-white transition-colors min-h-[48px] flex items-center justify-center border border-transparent">
          Learn More
        </a>
        <button 
          onClick={accept}
          className="px-6 py-2 bg-barn hover:bg-blue-600 text-white rounded text-[14px] font-bold transition-colors min-h-[48px] flex items-center justify-center cursor-pointer"
        >
          Accept & Close
        </button>
      </div>
